...
const AllContact = () => {
  ...
  return (
    <>
      <div>
        <h1>Your Contacts</h1>
        <a href="/mycontacts" className="btn btn-info my-2">
          Reload Contact
        </a>
        <hr className="my-4" />
        {loading ? (
            ...
            {contacts.length == 0 ? (
              ...
              <>
                ...
                <ReactHTMLTableToExcel
                    ...
                    className="download-table-xls-button btn btn-primary mb-2"
                    table="table-to-xls"
                    filename="contactList"
                    sheet="tablexls"
                    buttonText={
                      <span>
                         Download as EXCEL <BiSolidDownload />
                      </span>
                    }
                  /></div>
                <table className="table table-hover" id="table-to-xls">
                  <thead>
                    <tr className="table-dark table-sm">
